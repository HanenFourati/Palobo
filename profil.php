...
<body>
        ...
        if ($result->num_rows > 0) {
            ...
            if($row = $result->fetch_assoc()) {
				echo '<h1>Welcome,'.$row["username"].'</h1>'; echo '</div>';
...
?>
	 ...
	 <div id="fh5co-contact" class="fh5co-section animate-box">
			<div class="container">
               ...
               <p>Please fill this form to complet your account.</p>
	...
	<option value="ZW">Zimbabwe</option>
      		 ...
      		 <div class="form-group">  <input type="file" name="image" class="btn btn-primary btn-lg">      </div>   
            <div class="form-group">
...
//echo "$username,$first,$last,$gender,$age,$hometown,$country";
if($last!=''||$first !=''||$gender!=''||$age !=''||$hometown!=''||$country !=''){
//Insert Query of SQL
$query = mysqli_query($link,"INSERT INTO userinformation (username, first, last, gender, age, hometown, country,image)
 values ('$username','$first','$last','$gender','$age','$hometown','$country','$location')");
...
mysqli_close($link); // Closing Connection with Server
 //$username = htmlspecialchars($_SESSION['username']);
 //header("location: /PalestiniansBlog/welcome.php?username='.$username.'");    
